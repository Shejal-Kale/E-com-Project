package com.shejal.ecom_proj.model;
...
public class Product {
	...
	public Product(int id, String name, String description, String brand, BigDecimal price, String category,
			Date releaseDate, boolean avaiable, int quantity, String imageName, String imageType, byte[] imageData) {
		super();
		this.id = id;
		this.name = name;
		...
		this.productAvailable = avaiable;
